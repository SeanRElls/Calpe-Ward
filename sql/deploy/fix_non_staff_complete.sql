-- =====================================================
-- COMPREHENSIVE FIX FOR NON-STAFF FUNCTIONALITY
-- Addresses:
-- 1. Missing rpc_remove_non_staff_from_period function
-- 2. Ensures all column references are fully qualified
-- =====================================================

BEGIN;

-- =====================================================
-- 1. ENSURE rpc_get_period_non_staff HAS FULLY QUALIFIED COLUMNS
-- =====================================================
...
-- =====================================================
-- 2. ADD MISSING FUNCTION: rpc_remove_non_staff_from_period
-- =====================================================
...
BEGIN
    ...
    -- Get the non-staff person details with fully qualified columns
